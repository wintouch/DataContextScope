...
namespace Geturi.Data.Linq
{
    ...
    public interface IDataContextScopeFactory
    {
        ...
        /// is what you want in most cases. This ensures that the same DataContext instances
        ...
        /// and force the creation of new DataContext instances within that scope. Using 'ForceCreateNew'
        ...
        /// would result in multiple threads accesssing the same DataContext instances at the same 
        /// time.
        /// </summary>
