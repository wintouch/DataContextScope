...
namespace Numero3.EntityFramework.Implementation
{
  public class DataContextScope : IDataContextScope
  {
    ...
    public IDataContextCollection DbContexts { get { return _dbContexts; } }
    ...
    public void RefreshEntitiesInParentScope(IEnumerable entities)
    {
      ...
      //foreach (IDataContextAdapter contextInCurrentScope in _dbContexts.InitializedDbContexts.Values)
      //{
...
" + Environment.StackTrace;
    ...
    private static readonly ConditionalWeakTable<InstanceIdentifier, DataContextScope> DbContextScopeInstances = new ConditionalWeakTable<InstanceIdentifier, DataContextScope>();
